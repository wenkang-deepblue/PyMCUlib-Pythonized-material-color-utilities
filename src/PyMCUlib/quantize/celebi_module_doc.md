...
* `PyMCUlib.utils.utils`: For ARGB color manipulation and opacity checking
* `PyMCUlib.quantize.wu`: For Wu's color quantization algorithm
* `PyMCUlib.quantize.wsmeans`: For the WSmeans color quantization algorithm
