...
#### Example:
```python
from PyMCUlib.score import ScoreOptions
...
#### Example:
```python
from PyMCUlib.score import ranked_suggestions, ScoreOptions
...
* The component depends on the PyMCUlib.utils and PyMCUlib.cam.hct modules
