...
import math
from PyMCUlib.cam.cam import cam_from_int, cam_from_xyz_and_viewing_conditions
from PyMCUlib.cam.hct import Hct
from PyMCUlib.cam.viewing_conditions import DEFAULT_VIEWING_CONDITIONS
from PyMCUlib.dislike.dislike import fix_if_disliked
from PyMCUlib.dynamiccolor.contrast_curve import ContrastCurve
from PyMCUlib.dynamiccolor.dynamic_color import DynamicColor, foreground_tone
...
from PyMCUlib.utils.utils import lstar_from_y
...
def xyz_in_viewing_conditions(cam, viewing_conditions):
    ...
    from PyMCUlib.utils.utils import signum
    ...
    from PyMCUlib.utils.utils import Vec3
    return Vec3(x, y, z)
