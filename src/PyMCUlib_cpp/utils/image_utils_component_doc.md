...
from PyMCUlib_cpp.utils.image_utils import source_color_from_image
...
import numpy as np
from PIL import Image
from PyMCUlib_cpp.utils.image_utils import source_color_from_image_bytes
...
**Example:**
```python
from PyMCUlib_cpp.utils.image_utils import source_color_from_file
...
**Example:**
```python
from PyMCUlib_cpp.utils.image_utils import source_color_from_bytes
