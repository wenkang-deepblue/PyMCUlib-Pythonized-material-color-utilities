...
### Example:
```python
from PyMCUlib_cpp.contrast import ratio_of_ys
from PyMCUlib_cpp.utils import y_from_lstar
...
### Example:
```python
from PyMCUlib_cpp.contrast import ratio_of_tones
...
### Example:
```python
from PyMCUlib_cpp.contrast import lighter
...
### Example:
```python
from PyMCUlib_cpp.contrast import darker
...
### Example:
```python
from PyMCUlib_cpp.contrast import lighter_unsafe
...
### Example:
```python
from PyMCUlib_cpp.contrast import darker_unsafe
...
These functions are imported from the `PyMCUlib_cpp.utils` module.

## Complete Example

```python
from PyMCUlib_cpp.contrast import ratio_of_tones, lighter, darker, lighter_unsafe, darker_unsafe
from PyMCUlib_cpp.utils import y_from_lstar, lstar_from_y, int_from_lstar, hex_from_argb
